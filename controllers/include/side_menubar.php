<div class="col-md-3 left_col menu_fixed">
	<div class="left_col scroll-view">
	    <div class="navbar nav_title">
	        <a href="../dashboard/" class="site_title"><label style="font-family:stencil std;; text-shadow: 1px 1px 2px lightgreen;">DMMS</label><span style="font-family:AR Destine; text-shadow: 1px 1px 2px lightgreen;"> Nonescost</span></a>
	    </div>
