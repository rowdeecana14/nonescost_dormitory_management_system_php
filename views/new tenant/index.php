        ...
        <div class="right_col" role="main">
      		<div class="x_panel" >
				<div class="x_title">
                    ...
                    <h3 style="margin-left:50px; margin-top:-30px; font-size: 20px">New tenant</h3>
                    <div class="clearfix"></div>
                    <div class="btn-group pull-right" style="margin-top:-38px">
                       <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-search-tenant">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                        <input type="text" name="barcode" id="barcode" class="form-control has-feedback-left"  placeholder="Barcode" style="background-color:#eee;" >
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                        <input type="text" name="first_name" id="first_name" class="form-control has-feedback-left"  placeholder="First Name" style="text-transform:capitalize; background-color:#eee;" required>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                        <input type="text" name="middle_name" id="middle_name" class="form-control has-feedback-left"  placeholder="Middle Name" style="text-transform:capitalize; background-color:#eee;">
                                        <span class="fa fa-user form-control-feedback left" aria-hidden="true" style="color:black"></span>
                                    </div>

                                    <label class="col-md-12 col-sm-12 col-xs-12 form-group" for="last_name">Last Name: </label>
                                    <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                        <input type="text" name="last_name" id="last_name" class="form-control has-feedback-left"  placeholder="Last Name" style="text-transform:capitalize; background-color:#eee;" required>
                                        <span class="fa fa-user form-control-feedback left" aria-hidden="true" style="color:black"></span>
                                    </div>
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                        <input type="date" name="birth_date" id="birth_date" class="form-control has-feedback-left"   style="background-color:#eee;" required>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                        <input type="text" name="address" id="address" class="form-control has-feedback-left"  placeholder="Address" style="text-transform:capitalize; background-color:#eee;" required>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                        <input type="text" name="email" id="email" class="form-control has-feedback-left"  placeholder="Email" style="background-color:#eee;" required>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                        <input type="number" name="contact_no" id="contact_no" maxlength="11" class="form-control has-feedback-left"  placeholder="Contact number" style="background-color:#eee;" required>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="col-md-6 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                            <input type="text" name="mother" id="mother" class="form-control has-feedback-left"  placeholder="Mother Name" style="text-transform:capitalize; background-color:#eee;" >
                                            <span class="fa fa-user form-control-feedback left" aria-hidden="true" style="color:black"></span>
                                        </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                            <input type="text" name="mother_occ" id="mother_occ" class="form-control has-feedback-left"  placeholder="Work" style="text-transform:capitalize; background-color:#eee;">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                            <input type="text" name="father" id="father" class="form-control has-feedback-left"  placeholder="Father Name" style="text-transform:capitalize; background-color:#eee;" >
                                            <span class="fa fa-user form-control-feedback left" aria-hidden="true" style="color:black"></span>
                                        </div>

                                        <label class="col-md-12 col-sm-12 col-xs-12 form-group" for="father_occ">Work: </label>
                                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                            <input type="text" name="father_occ" id="father_occ" class="form-control has-feedback-left"  placeholder="Work" style="text-transform:capitalize; background-color:#eee;" >
                                            <span class="fa fa-briefcase form-control-feedback left" aria-hidden="true" style="color:black"></span>
                                        </div>
                                    ...
                                    <div class="col-md-6 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                            <input type="text" name="parent_address" id="parent_address" class="form-control has-feedback-left"  placeholder="Address" style="text-transform:capitalize; background-color:#eee;" >
                                            <span class="fa fa-user form-control-feedback left" aria-hidden="true" style="color:black"></span>
                                        </div>

                                        <label class="col-md-12 col-sm-12 col-xs-12 form-group" for="parent_email">Email:</label>
                                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                            <input type="email" name="parent_email" id="parent_email" class="form-control has-feedback-left"  placeholder="Email" style="background-color:#eee;">
                                            <span class="fa fa-envelope form-control-feedback left" aria-hidden="true" style="color:black"></span>
                                        </div>

                                        <label class="col-md-12 col-sm-12 col-xs-12 form-group" for="parent_contact">Contact no: </label>
                                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                            <input type="number" name="parent_contact" id="parent_contact" class="form-control has-feedback-left" maxlength="11"  placeholder="Contact no" style="background-color:#eee;" >
                                            <span class="fa fa-phone form-control-feedback left" aria-hidden="true" style="color:black"></span>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <br>
                                            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                                <input type="text" name="search_tenant" id="search_tenant" class="form-control" style="height: 40px;  background-color:#eee;"  placeholder="Search here.." >
                                                <br>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $("#new_tenant_form").submit(function(e){
                ...
                var form = $("#new_tenant_form").serializeArray();
            ...
            //SEARCH TENANT
            $("#search_tenant").keydown(function() {
               searchTenant();
            });
            $("#search_tenant").keyup(function() {
               searchTenant();
            });
        });
        ...
        function searchTenant() {
            ...
            if($("#search_tenant").val() == "") {
                var html = "";
                html += '' +
                    '<tr>' +
                        '<td colspan="4"><center>No records fund.</center></td>' +
                    '</tr>';
