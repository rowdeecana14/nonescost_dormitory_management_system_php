                                ...
                                <div class="row">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <label class="col-md-12 col-sm-12 col-xs-12 form-group" for="tenant_id">Tenant name:</label>
                                                <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                                    <select class="select2 form-control" name="tenant_id" id="tenant_id" style="background-color:#eee; width:100%"   required>
