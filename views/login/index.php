...
<head>
  ...
  <link rel="icon" href="../../images/nonescost.png">
  <!-- Bootstrap 3.3.6 -->
      ...
      <nav class="navbar navbar-static-top" style="background-color:#2E8B57;">
        <div class="container">
          <div class="navbar-header">
              <a href="index.php" class="navbar-brand"><b style="color:white">NONESCOST - DMMS </b></a>
                        ...
                        <div id="#addModal" class="modal-dialog modal-success modal-fade modal-sm pull-left" style="width:330px !important;">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <center><h3 class="modal-title"><img src="../../images/login.png" height="45px"> Login Form</h3></center>
                                    </div>
