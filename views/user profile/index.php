...
<html lang="en"> 
          ...
          <div class="x_panel" >
            <div class="x_title">
                <img src="../../images/profile.png" width="40px" height="40px">
                  <h3 style="margin-left:50px; margin-top:-30px; font-size: 20px"> My profile</h3>
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      ...
                      <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                          ...
                          <li role="presentation" ><a href="#tab_content2" id="password-tab" role="tab" data-toggle="tab" aria-expanded="true"><span class="badge bg-gray "><i class="fa fa-key"></i></span> Change password</a>
                          </li>
                        </ul>
                                  ...
                                  <div class="col-md-12 col-sm-12 col-xs-12">
                                      <div class="col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <div class="col-md-10 col-sm-12 col-xs-12">
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                                    <input type="text" name="username" id="username" value="<?php echo $data['username']; ?>" class="form-control has-feedback-left"  placeholder="Username" style=" background-color:#eee;" required>
                                                    <span class="fa fa-user form-control-feedback left" aria-hidden="true" style="color:black"></span>
                                                </div>

                                                <label class="col-md-12 col-sm-12 col-xs-12 form-group" for="current_password">Current Password: </label>
                                                <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                                    <input type="password" name="current_password" id="current_password" class="form-control has-feedback-left"  placeholder="Password" style=" background-color:#eee;" required>
                                                    <span class="fa fa-key form-control-feedback left" aria-hidden="true" style="color:black"></span>
                                                </div>

                                                <label class="col-md-12 col-sm-12 col-xs-12 form-group" for="new_password">New Password: </label>
                                                <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                                    <input type="password" name="new_password" id="new_password" class="form-control has-feedback-left"  placeholder="Confirm password" style=" background-color:#eee;" required>
                                                    <span class="fa fa-key form-control-feedback left" aria-hidden="true" style="color:black"></span>
                                                </div>
                                            ...
                                            <div class="col-md-10 col-sm-12 col-xs-12">
                                                <div class="col-md-8 col-sm-12 col-xs-12" id="matching_message">
  ...
  <script type="text/javascript">
  var selected = "upload";
  var check_current_password = true;
  var check_password_match = true;
    ...
    $("#confirm_password").keyup(function(e){ 
     ...
     $("#update_user_form").submit(function(e){ 
        try {
            ...
            form.push({name: 'action', value: 'update_user_details'});
     ...
     $("#update_password_form").submit(function(e){
        ...
        if(check_current_password == false) {
            $("#modal-error").modal("show");
            $(".modal-alert-message").text("Current password is incorrect.");
            setTimeout(function() {
                 window.location.reload();
            }, 2500);
        ...
        if(check_password_match == false) {
            $("#modal-error").modal("show");
            $(".modal-alert-message").text("Password not match.");
            setTimeout(function() {
                 window.location.reload();
            }, 2500);
        ...
        try {
            ...
            var user_id = "<?php echo $user_id; ?>";
            var form = $("#update_password_form").serializeArray();
            form.push({name: 'action', value: 'update_password'});
            form.push({name: 'user_id', value: user_id});
            ...
            if(response.is_error == false) {
                $("#modal-information").modal("show");
                $(".modal-alert-message").text("Username or password successfuly updated.");
                setTimeout(function() {
                     window.location.reload();
                }, 2500);
              // alert("Username or password successfuly updated.");
              // window.location.reload();
            }
            else {
                $("#modal-error").modal("show");
                $(".modal-alert-message").text("Username or password not updated.");
                setTimeout(function() {
                     window.location.reload();
                }, 2500);
                // alert("Username or password not updated.");
                // window.location.reload();
            }
          ...
          if(response == true) {
               $("#matching_message").html(
                '<div class="alert alert-success text-center" role="alert">' +
                  '<strong><span class="fa fa-check"></span> Correct password.</strong>' +
               '</div>'
            );
            check_current_password = true;
               ...
               $("#matching_message").html(
                '<div class="alert alert-warning text-center" role="alert">' +
                  '<strong><span class="fa fa-times-circle"></span> Incorrect password.</strong>' +
               '</div>'
            );
            check_current_password = false;
          }
